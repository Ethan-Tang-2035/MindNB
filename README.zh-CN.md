...
**[下载 MindNB 0.1.0 预览版](https://github.com/Ethan-Tang-2035/MindNB/releases/tag/v0.1.0)。** 以下四个目标均已提供安装包，并通过自动构建、安装冒烟和桌面测试。当前为未签名预览版，macOS 尚未完成 Apple 公证；具体验证范围与限制见版本说明。
